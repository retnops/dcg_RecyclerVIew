...
holder.tvFrom.setText(getListHero().get(position).getFrom());
    Glide.with(context).load(getListHero().get(position).getPhoto()).apply(new RequestOptions().override(55,55)).into(holder.imgPhoto);
    }
    ...
    public int getItemCount() {
     ...
     class CategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imgPhoto;
         ...
         CategoryViewHolder(@NonNull View itemView) { super(itemView);
